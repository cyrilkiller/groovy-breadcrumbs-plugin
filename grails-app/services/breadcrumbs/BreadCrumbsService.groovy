...
class BreadCrumbsService {
	...
	private static final NAMESPACE = "breadcrumbs"
	
	/** key for retrieve actionName  */
	private static final ACTION_NAME = "actionName"
	
	/** key for retrieve controllerName  */
	private static final CONTROLLER_NAME = "controllerName"
	...
	def findOverrideParams(BreadCrumbs breadCrumbs){		
		...
		}else if(2.equals(breadCrumbs.scope().value())){
			return retrievesFromRequest(breadCrumbs)
		}else if(3.equals(breadCrumbs.scope().value())){
